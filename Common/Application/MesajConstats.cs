...
{
    public class MesajConstats
    {
        public static string SilmeMesaji = "Silme işlemi başarılı şekilde tamamlanmıştır.";
        public static string GuncellemeMesaji = "Güncelleme işlemi başarılı şekilde tamamlanmıştır.";
        ...
        public static string Success = "Bilgiler getirildi.";
    }
}
